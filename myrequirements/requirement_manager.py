...
def main(input_file):
    ...
    run myrequirements <yourfile.json> , this command will generate rewuirements file for 
    development and deployment 

    json file should have key[requirements]:value[boolean true/false]
    true : requirement is used in deployment 
    false : requirement is only for development and will not be used in deployment 
    """
